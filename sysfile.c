...
// task 4 step 1. check if the noFollow flag got specified and then open the file desciptor for the symlink inode
int
sys_open(void)
{
  char *path;
...
/*
Tasks:
1. create and allocate a new File and an inode
2. write in this inode the path you want him to have
3. change filetype to syslink
4. change other syscalls so there interacting like we want it to beip = create(path, T_DIR, 0, 0)
